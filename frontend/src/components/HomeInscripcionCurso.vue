...
<div>
  ...
  <div class="container">
    ...
    <br>
    <router-link to="/inscripcion/curso" tag="button" class="btn btn-info" title="Ir a Nuevo Producto" style="float:left;">
...
export default {
  ...
  methods: {
    getDatos() {      
      axios.get('http://localhost:3000/inscripcion/curso').then(response => {
        this.datos = response.data;
      })
      
    },

    verEstado(inscripcion){
      this.$router.push('/estado/'+inscripcion.idalumno +'/'+ inscripcion.idcurso);
    }
